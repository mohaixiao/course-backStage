...
const yData = ["直接访问", "百度", "360浏览器", "CSDN"]; // 来源
const data = [431, 341, 131, 98]; // 访问人数
...
const TopWebsite = () => {
  ...
  return (
    <div
      className="h-[14.5rem] w-[58rem] flex flex-col 
    bg-top-website bg-no-repeat bg-center bg-cover mb-10"
    >
      <div className="px-8 pt-4 text-[#17caf0]  font-bold">TOP网站来源</div>
